...
llm = ChatOpenAI(model="Qwen3-Coder", temperature=0.2, base_url='https://apis.iflow.cn/v1', api_key='sk-43fb906bef4159588136ae7062486dfd')
    ...
    while True:
        ...
        if response['tool_calls']:
            ...
            for tool_call in response['tool_calls']:
                ...
                logger.info(f"准备调用工具: {tool_name}, 参数: {tool_args}")
                ...
                if tool_name == "str_replace":
                    ...
                    if missing_params:
                        logger.error(f"str_replace 工具缺少必需参数: {missing_params}")
        ...
        # 处理自定义<tool_call>标签
            ...
            tool_name = tool_call['name']
            tool_args = tool_call['args']
            logger.info(f"准备调用工具 (tool_call标签): {tool_name}, 参数: {tool_args}")
